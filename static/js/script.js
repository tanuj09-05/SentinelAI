// ===============================
// SentinelAI Landing Page Script
// ===============================
...
for (let i = 0; i < 20; i++) {
    ...
    particle.style.animation =
        `float ${4 + Math.random() * 5}s infinite ease-in-out`;
...
console.log("%cSentinelAI",
"color:#7c3aed;font-size:30px;font-weight:bold;");

console.log(
"AI Surveillance & Security Intelligence Platform"
);